...
def join_button(request):
    ...
    end_j_datetime = datetime(2025, 2, 21)  # 지원서 제출 끝나는 날짜와 시간(이 날짜로 바뀌는 순간 끝남. 즉, 20일 11:59까지 받고 싶으면 21로 입력해야함.)
    start_r_datetime = datetime(2025, 2, 21, 15)  # 합격자 조회 시작 날짜와 시간
